...
setInterval(function(){
    ...
    var str = ".banner .img-wrapper:nth-child("+child+")";
    console.log(str)
    let elements = document.getElementsByClassName("img-wrapper");
    ...
    document.querySelectorAll(str)[0].style.display = "flex";
    document.querySelectorAll(str)[0].classList.toggle("slide-in");

}, 2000);

//mapping method for menu
